...
#Load store data from county selection
programloc<-st_read("data/programloc_190816.gpkg",layer="programloc_190816",stringsAsFactors=FALSE,quiet=TRUE)
...
observeEvent(c(input$officegroup, input$county1, input$loadstores2),{
 #storepal<-colorFactor(palette="YlOrRd",msadata_reactive()$year_range,reverse=TRUE)
  ...
  storepal1<-colorFactor(palette=c("red","blue","green","purple","orange"),unique(programloc$Type),reverse=TRUE)
